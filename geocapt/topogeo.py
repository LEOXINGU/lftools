...
def str2HTML(texto):
    if texto:
        dicHTML = { 'Á': '&Aacute;',	'á': '&aacute;',	'Â': '&Acirc;',	'â': '&acirc;',	'À': '&Agrave;',	'à': '&agrave;',	'Å': '&Aring;',	'å': '&aring;',	'Ã': '&Atilde;',	'ã': '&atilde;',	'Ä': '&Auml;',	'ä': '&auml;', 'ú': '&uacute;', 'Ú': '&Uacute;', 'Æ': '&AElig;',	'æ': '&aelig;',	'É': '&Eacute;',	'é': '&eacute;',	'Ê': '&Ecirc;',	'ê': '&ecirc;',	'È': '&Egrave;',	'è': '&egrave;',	'Ë': '&Euml;',	'ë': '&Euml;',	'Ð': '&ETH;',	'ð': '&eth;',	'Í': '&Iacute;',	'í': '&iacute;',	'Î': '&Icirc;',	'î': '&icirc;',	'Ì': '&Igrave;',	'ì': '&igrave;',	'Ï': '&Iuml;',	'ï': '&iuml;',	'Ó': '&Oacute;',	'ó': '&oacute;',	'Ô': '&Ocirc;',	'ô': '&ocirc;',	'Ò': '&Ograve;', 'Õ': '&Otilde;', 'õ': '&otilde;',	'ò': '&ograve;',	'Ø': '&Oslash;',	'ø': '&oslash;',	'Ù': '&Ugrave;',	'ù': '&ugrave;',	'Ü': '&Uuml;',	'ü': '&uuml;',	'Ç': '&Ccedil;',	'ç': '&ccedil;',	'Ñ': '&Ntilde;',	'ñ': '&ntilde;',	'Ý': '&Yacute;',	'ý': '&yacute;',	'"': '&quot;', '”': '&quot;',	'<': '&lt;',	'>': '&gt;',	'®': '&reg;',	'©': '&copy;',	'\'': '&apos;', 'ª': '&ordf;', 'º': '&ordm;', '°':'&deg;', '²':'&sup2;', '¿':'&iquest;', '¡':'&iexcl;', '–': '&ndash;', '—': '&mdash;', 
                    ...
                    '√': '&radic;', '∞': '&infin;', '≈': '&asymp;', '≠': '&ne;', '≤': '&le;', '≥': '&ge;', '±': '&plusmn;', '÷': '&divide;', '×': '&times;', '∑': '&sum;', '∏': '&prod;', '∫': '&int;', '∂': '&part;', '∇': '&nabla;', '∈': '&isin;', '∉': '&notin;', '∩': '&cap;', '∪': '&cup;', '⊂': '&sub;', '⊃': '&sup;', '⊆': '&sube;', '⊇': '&supe;', '∧': '&and;', '∨': '&or;', '¬': '&not;', '∴': '&there4;', '∝': '&prop;', '∠': '&ang;', '⊥': '&perp;', '≡': '&equiv;', '∅': '&empty;', '∃': '&exist;', '∀': '&forall;', '∴': '&there4;', '∵': '&because;', '→': '&rarr;',
                    }
        for item in dicHTML:
            if item in texto:
