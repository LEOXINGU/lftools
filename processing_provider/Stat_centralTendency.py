        ...
        if estat == 0: # média
            if not TemZ:
                itens  = {
                    ...
                    'min_x' : QMetaType.Type.Double,
                    'min_y' : QMetaType.Type.Double,
                    'avg_x' : QMetaType.Type.Double,
                    'avg_y' : QMetaType.Type.Double,
                    'max_x' : QMetaType.Type.Double,
                    'max_y' : QMetaType.Type.Double,
                ...
                itens  = {
                    ...
                    'min_x' : QMetaType.Type.Double,
                    'min_y' : QMetaType.Type.Double,
                    'min_z' : QMetaType.Type.Double,
                    'avg_x' : QMetaType.Type.Double,
                    'avg_y' : QMetaType.Type.Double,
                    'avg_z' : QMetaType.Type.Double,
                    'max_x' : QMetaType.Type.Double,
                    'max_y' : QMetaType.Type.Double,
                    'max_z' : QMetaType.Type.Double,
                    'std_x' : QMetaType.Type.Double,
                    'std_y' : QMetaType.Type.Double,
                    'std_z' : QMetaType.Type.Double,
                    }
            ...
            if not TemZ:
                itens  = {
                    ...
                    'min_x' : QMetaType.Type.Double,
                    'min_y' : QMetaType.Type.Double,
                    'perc25_x' : QMetaType.Type.Double,
                    'perc25_y' : QMetaType.Type.Double,
                    'median_x' : QMetaType.Type.Double,
                    'median_y' : QMetaType.Type.Double,
                    'perc75_x' : QMetaType.Type.Double,
                    'perc75_y' : QMetaType.Type.Double,
                    'max_x' : QMetaType.Type.Double,
                    'max_y' : QMetaType.Type.Double,
                    }
            else:
                itens  = {
                    ...
                    'perc25_x' : QMetaType.Type.Double,
                    'perc25_y' : QMetaType.Type.Double,
                    'perc25_z' : QMetaType.Type.Double,
                    'median_x' : QMetaType.Type.Double,
                    'median_y' : QMetaType.Type.Double,
                    'median_z' : QMetaType.Type.Double,
                    'perc75_x' : QMetaType.Type.Double,
                    'perc75_y' : QMetaType.Type.Double,
                    'perc75_z' : QMetaType.Type.Double,
                    'max_x' : QMetaType.Type.Double,
                    'max_y' : QMetaType.Type.Double,
                    'max_z' : QMetaType.Type.Double,
                    }
