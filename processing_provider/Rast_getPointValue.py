...
class GetPointValue(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        ...
        footer = '''<div align="center">
                      ...
                      <div align="left">
                      <p>
                      <b><a href="'''+ self.tr('https://portal.geoone.com.br/m/lessons/sensoriamento?classId=2124') + '''" target="_blank">'''+ self.tr('Click here to watch a full class on this tool',
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        if n_banda == 0:
            for k in range(total_bands):
                Fields.append(QgsField(prefixo + self.tr('band_{}'.format(k+1)), QMetaType.Type.Double))

        else:
            Fields.append(QgsField(prefixo + self.tr('band_{}'.format(n_banda)), QMetaType.Type.Double))
