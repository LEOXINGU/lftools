...
class ImportPhotos(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        fields = QgsFields()
        fields.append(QgsField(self.tr('name'), QMetaType.QString))
        ...
        fields.append(QgsField(self.tr('date_time'), QMetaType.QString))
        fields.append(QgsField(self.tr('path'), QMetaType.QString))
        fields.append(QgsField(self.tr('make','fabricante'), QMetaType.QString))
        fields.append(QgsField(self.tr('model','modelo'), QMetaType.QString))
        if YPR:
