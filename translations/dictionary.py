...
'Generate text file with Ground Control Points (GCP) from a point layer.' : {'es': 'Genere un archivo de texto con puntos de control terrestre (GCP) a partir de una capa de puntos.'},
